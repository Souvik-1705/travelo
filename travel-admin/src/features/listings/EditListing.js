...
function EditListing() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="edit-form">
      <h3>Edit Listing</h3>
      <input name="placeName" value={formData.placeName} onChange={handleChange} /><br />
      <input name="pricePerNight" value={formData.pricePerNight} onChange={handleChange} /><br />
      <input name="city" value={formData.city} onChange={handleChange} /><br />
      <input name="pin" value={formData.pin} onChange={handleChange} /><br />
      ...
      <label className="checkbox-label">
        Available: <input type="checkbox" name="availability" checked={formData.availability} onChange={handleChange} />
      </label><br />
